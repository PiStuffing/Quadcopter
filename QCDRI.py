...
class MPU6050 :
    ...
    __SCALE_ACCEL = 8.0 / 65536 #AB! Try 4 if I shows no 2g hits
    ...
    def __init__(self, address=0x68, alpf=1, glpf=1):
        ...
        self.i2c.write8(self.__MPU6050_RA_ACCEL_CONFIG, 0x08)  #AB! Try 0x00 if 0x08 shows no 2g hits
        time.sleep(0.1)
        ...
        #-------------------------------------------------------------------------------------------
#        self.i2c.write(self.__MPU6050_RA_MAG_CNTL1, 0x12)  # 0x10 = 16-bit, 0x01 = one-shot, 0x02 = continuous
    ...
    def readSensors(self):
        ...
        if az > 65536 / 4:   # +2g on a scale of +/-4g
            self.num_2g_hits += 1
